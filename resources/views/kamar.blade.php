...
<div class="row fasilitas">
    <div class="col-md-3">
        <a class="card card-light" href="#">
            ...
            <div class="card-body p-1">
                <img src="/Bahan/images/sarapan.jpg" class="img-fluid rounded" />
            </div>
    ...
    <div class="col-md-3">
        <a class="card card-light" href="#">
            ...
            <div class="card-body p-1">
                <img src="/Bahan/images/kolam_renang.jpg" class="img-fluid rounded" />
            </div>
    ...
    <div class="col-md-3">
        <a class="card card-light" href="#">
            ...
            <div class="card-body p-1">
                <img src="/Bahan/images/restoran.jpg" class="img-fluid rounded" />
            </div>
    ...
    <div class="col-md-3">
        <a class="card card-light" href="#">
            ...
            <div class="card-body p-1">
                <img src="/Bahan/images/resepsionis.jpg" class="img-fluid rounded" />
            </div>
        </a>
    </div>
</div>
...
<div class="row kamar">
    <div class="col-md-4">
        <a class="card card-light" href="#">
            ...
            <div class="card-body p-1">
                <img src="/Bahan/images/kamar_standar.jpg" class="img-fluid rounded" />
            </div>
    ...
    <div class="col-md-4">
        <a class="card card-light" href="#">
            ...
            <div class="card-body p-1">
                <img src="/Bahan/images/kamar_suite.jpg" class="img-fluid rounded" />
            </div>
            <div class="card-footer">
                Rp. 400.000
            </div>
    ...
    <div class="col-md-4">
        <a class="card card-light" href="#">
            ...
            <div class="card-body p-1">
                <img src="/Bahan/images/kamar_deluxe.jpg" class="img-fluid rounded" />
            </div>
            <div class="card-footer">
                Rp. 700.000
            </div>
